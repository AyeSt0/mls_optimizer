...
STR = {
  "title": "MLS Optimizer — One-Click GUI (v6.5 EN)",
  "sec_files": "Input Files",
  "excel": "Excel:",
  "name_map": "name_map.json:",
  "sec_lang": "Language & Model",
  "target_lang": "Target language:",
  "custom_code": "or custom code:",
  "provider": "Provider:",
  "model": "Model:",
  ...
  "max": "Max:",
  "rpm": "RPM:",
  "glossary_max": "Glossary Max:",
  "sec_opt": "Options",
  "context_mode": "Context mode:",
  "scene": "Scene (recommended)",
  "window": "Window",
  "include_system": "Include system lines",
  "resume": "Resume",
  "run_full": "Run FULL Pipeline",
  "run_translate": "Run TRANSLATE only",
  "open_artifacts": "Open artifacts",
  "open_config": "Open config",
  "help": "Help",
  "stop": "Stop",
  "ready": "Ready",
  "help_text": "1) Put MLS Chinese.xlsx and name_map.json into data/\n2) Fill your API keys in config/settings.local.yaml\n3) Pick target language (or custom code), click Run FULL Pipeline\nEnabled: resume / autosave / glossary-first / live logs"
}
